...
# Global variables
# QuickUMLS object
matcher = QuickUMLS(quickumls_fp=f'{umls_folder}/QuickUMLS', overlapping_criteria='score', threshold=0.8, similarity_name='cosine', window=5)
ARGS = None
# TUI list
...
dirchunks = f"{data_folder}/data/chunkssmall/"
diroutputchunks = f"{data_folder}/data/outputchunkssmall/"
...
if __name__ == "__main__":
    ...
    print('number of cpu processing: ', os.cpu_count()-4)
