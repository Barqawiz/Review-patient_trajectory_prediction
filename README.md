...
5. **Improve GRU training**: update the GRU neural network for admission to support a variation of optimizers for performance validation and to receive a parameter that activates bi-directional GRU.
